  ...
  return (
    <div className="tasksContainer">
      <header className={styles.taskCreator}>
        {/* Применил контекст для предачи функций на сортировку в компонент SortButtons  */}
        <FilterContext value={{ sortOnServer, sortById, sortByAlphabet, filters }}>
          <CreateTask createTask={createTask} />
        </FilterContext>
      </header>
      <ul>
        {todos.map((task) => (
          // Передаю все данные и функции в компоненты Editor и TaskWithDeleteOption
          <TaskContext
            key={task.id}
            value={{
              ...task,
